...
hi DiffAdd guifg=#50fa7b ctermfg=84 guibg=#646568 ctermbg=242 gui=NONE cterm=NONE
hi DiffChange guifg=#8be9fd ctermfg=117 guibg=#646568 ctermbg=242 gui=NONE cterm=NONE
hi DiffDelete guifg=#ff5555 ctermfg=203 guibg=#646568 ctermbg=242 gui=NONE cterm=NONE
hi DiffText guifg=#19191e ctermfg=234 guibg=#bd93f9 ctermbg=141 gui=NONE cterm=NONE
...
hi NormalFloat guifg=NONE ctermfg=NONE guibg=#19191e ctermbg=234 gui=NONE cterm=NONE
hi StatusLine guifg=#dbdbdb ctermfg=253 guibg=#19191e ctermbg=234 gui=NONE cterm=NONE
